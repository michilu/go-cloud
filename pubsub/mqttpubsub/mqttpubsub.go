...
// Package mqttpubsub provides a pubsub implementation that uses MQTT
// PubSub. Use OpenTopic to construct a *pubsub.Topic, and/or OpenSubscription
// to construct a *pubsub.Subscription.
//
// URLs
//
// For pubsub.OpenTopic and pubsub.OpenSubscription, mqttpubsub registers
// for the scheme "mqttpubsub".
...
//
// MQTT Pub/Sub supports at-least-once semantics; applications must
...
import (
	...
	raw "github.com/eclipse/paho.mqtt.golang"
...
var recvBatcherOpts = &batcher.Options{
	// MQTT Pub/Sub returns at most 1000 messages per RPC.
	MaxBatchSize: 1000,
	MaxHandlers:  10,
}
...
const Scheme = "mqttpubsub"

// URLOpener opens MQTT Pub/Sub URLs like "mqttpubsub://projects/myproject/topics/mytopic" for
// topics or "mqttpubsub://projects/myproject/subscriptions/mysub" for subscriptions.
//
// The shortened forms "mqttpubsub://myproject/mytopic" for topics or
// "mqttpubsub://myproject/mysub" for subscriptions are also supported.
//
...
// Dial opens a gRPC connection to the MQTT Pub Sub API.
//
...
func SubscriberClient(ctx context.Context, conn *grpc.ClientConn) (*raw.SubscriberClient, error) {
	return raw.NewClient(ctx, option.WithGRPCConn(conn))
}

// TopicOptions will contain configuration for topics.
type TopicOptions struct{}

// OpenTopic returns a *pubsub.Topic backed by an existing MQTT PubSub topic
...
// OpenTopicByPath returns a *pubsub.Topic backed by an existing MQTT PubSub
...
// OpenSubscription returns a *pubsub.Subscription backed by an existing MQTT
...
// MQTT PubSub subscription. subscriptionPath must be of the form
